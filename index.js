...
let menuitem =[ parseInt(vegBPrice), parseInt(nonVegPrice), parseInt(mandhiPrice), parseInt(whiteRicePrice), parseInt(entergst)];
let sum=0;      
...
// output values
    document.getElementById("getrslt").innerHTML =  "</br>" +"Personal Detail"+"<br> <br>" +
                                                    "Name :&nbsp " +   userName + "<br>" +
                                                     "Email :&nbsp  " +  userEmail +"<br>"+
                                                     "Mobile No :&nbsp " + userMobile + "<br>"+
                                                     "Place :&nbsp  " +  userPlace + "<br> <br>"+
                                                    "Menu <br><br>"+
                                 
                                                    "Total Amount : "+ sum + "<br>" +
                                                    "GST persentage &nbsp " + gstpersentage+"%"+ "&nbsp"+
                                                    " GST Ammout : "+  entergst+"<br>"+
                                                    " Total : "+  gsttotal + "<br>"+
                                                    " Tip amount is : " + tip + "<br>" + "<h5 style='color:black'> Total Amount with Tip : </h5> " +totalamount + "<br> <br> " ;
